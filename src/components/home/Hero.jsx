...
export default function Hero() {
  return (
    <section className="relative flex min-h-[calc(100vh-5rem)] items-center overflow-hidden bg-hero">
      ...
      <div className="relative mx-auto grid w-full max-w-7xl gap-10 px-4 sm:px-6 py-16 sm:py-20 lg:grid-cols-[1.1fr_1fr] lg:items-center">
        <div className="animate-fade-up">
          ...
          <h1 className="mt-5 text-4xl font-bold leading-[1.08] tracking-tight sm:text-5xl md:text-6xl lg:text-7xl">
          ...
          <div className="mt-8 flex flex-wrap gap-3 sm:gap-4">
            <a
              ...
              className="group inline-flex items-center gap-2 rounded-full bg-primary px-6 py-3 text-sm font-semibold text-primary-foreground transition-all hover:glow-sm hover:brightness-110 sm:px-7 sm:py-3.5"
            >
              Get Started <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-1" />
            </a>
            <Link
              to="/services"
              className="inline-flex items-center gap-2 rounded-full border border-primary/50 px-6 py-3 text-sm font-semibold text-foreground transition-all hover:bg-primary/10 sm:px-7 sm:py-3.5"
            >
              See Our Work
            </Link>
          </div>
